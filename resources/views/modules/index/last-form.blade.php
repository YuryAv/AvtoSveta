<section class="index-selection section">
    <div class="container">
        <h2 class="index-selection__title">Остались вопросы?</h2>
        <h4 class="index-selection__subtitle c-bg">Получите консультацию по цене, с учетом затрат (доставка и растаможка) или по любому другому вопросу.</h4>
